...
const Home = () => {
  ...
  const glowVariants = {
    ...
    hover: {
      scale: 1.2, y: -3,
      filter: "drop-shadow(0 0 8px rgba(13,80,204,0.9)) drop-shadow(0 0 18px rgba(16,185,129,0.8))",
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          rounded-full
          bg-gradient-to-r from-[#302b63] via-[#0038f8] to-[#1cd8d2]
